...
const required = ["index.html", "styles.css", "script.js", "favicon.svg", "devkit-hero.png", "og.png", "robots.txt", "sitemap.xml"];
...
if (!html.includes("favicon.svg")) throw new Error("The site favicon is not wired into the page.");
